...
async function onclick() {
  const buffer = await exportExcel(luckysheet.getluckysheetfile());
  console.log(buffer);
  saveByteArray("demo.xlsx", buffer);
}
...
var exportExcel = (exports.exportExcel = async function (luckysheet) {
...
const App = () => {
  ...
  return (
    <div>
      ...
      ></div>
      <br />
      <button onClick={onclick}>download xlsx</button>
    </div>
  );
};
